...
public class DataAnggotaFrame extends JFrame {
    ...
    public DataAnggotaFrame(Petugas petugas) {
        ...
        // Style untuk SEMUA TOMBOL - TEKS HITAM
        // Tambah button (Hijau)
        tambahBtn.setBackground(new Color(76, 175, 80));      // Background hijau
        tambahBtn.setForeground(Color.BLACK);                 // Teks HITAM
        ...
        tambahBtn.setContentAreaFilled(true);  // Penting: background terisi penuh
        tambahBtn.setCursor(new Cursor(Cursor.HAND_CURSOR));

        // Edit button (Kuning/Oranye)
        editBtn.setBackground(new Color(255, 152, 0));        // Background oranye
        editBtn.setForeground(Color.BLACK);                   // Teks HITAM
        ...
        editBtn.setContentAreaFilled(true);    // Penting: background terisi penuh
        editBtn.setCursor(new Cursor(Cursor.HAND_CURSOR));

        // Hapus button (Merah)
        hapusBtn.setBackground(new Color(244, 67, 54));       // Background merah
        hapusBtn.setForeground(Color.BLACK);                  // Teks HITAM
        ...
        hapusBtn.setContentAreaFilled(true);   // Penting: background terisi penuh
        hapusBtn.setCursor(new Cursor(Cursor.HAND_CURSOR));

        // Refresh button (Biru)
        refreshBtn.setBackground(new Color(33, 150, 243));    // Background biru
        refreshBtn.setForeground(Color.BLACK);                // Teks HITAM
        ...
        refreshBtn.setContentAreaFilled(true); // Penting: background terisi penuh
        refreshBtn.setCursor(new Cursor(Cursor.HAND_CURSOR));

        // Tutup button (Abu-abu)
        tutupBtn.setBackground(new Color(96, 125, 139));      // Background abu-abu
        tutupBtn.setForeground(Color.BLACK);                  // Teks HITAM
        ...
        tutupBtn.setContentAreaFilled(true);   // Penting: background terisi penuh
